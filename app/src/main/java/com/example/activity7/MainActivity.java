...
public class MainActivity extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(com.example.sqliteconnection.MainActivity.this);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(com.example.sqliteconnection.MainActivity.this,TemanBaru.class);
        ...
        recyclerView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                ...
                Intent intent = new Intent(com.example.sqliteconnection.MainActivity.this,MenampilkanData.class);
                startActivity(intent);
